      ...
      <div style={styles.content}>
        ...
        <div style={styles.grid}>
          {members.map((member) => (
            <div key={member.id} style={styles.memberCard} onClick={() => handleSelect(member)}>
              ...
              {member.phone && <p style={styles.memberPhone}>📞 {member.phone}</p>}
        ...
        {showAdd && (
          <div style={styles.formBox}>
            ...
            <input style={styles.input} placeholder="📞 Guardian phone number (e.g. 0771234567)" type="tel" value={newMember.phone} onChange={(e) => setNewMember({ ...newMember, phone: e.target.value })} />
...
const styles = {
  ...
  memberAge: { margin: '0 0 4px', color: '#999', fontSize: '12px' },
  memberPhone: { margin: '0 0 10px', color: '#356e61', fontSize: '11px' },
